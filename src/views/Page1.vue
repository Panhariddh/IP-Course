<template>
  <div class="page">
    <aside>
      <h3>Menu</h3>
      <ul>
        <li><router-link to="/page1/section/1">Section 1</router-link></li>
        <li><router-link to="/page1/section/2">Section 2</router-link></li>
        <li><router-link to="/page1/section/3">Section 3</router-link></li>
        <li><router-link to="/page1/section/4">Section 4</router-link></li>
      </ul>
    </aside>
    <section>
      ...
      <!-- Display input field only if no section is selected -->
      <div v-if="!isSectionActive">
        <p>Add a Message:</p>
  ...
  methods: {
    addMessage() {
      if (this.message.trim() !== '') {
        ...
        messageStore.addMessage(`The message is from Page 1: ${this.message}`);
